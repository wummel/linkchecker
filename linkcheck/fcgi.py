...
class Record (object):
    ...
    def read_record (self, sock):
        ...
        self.version, self.recType, padding_length = s[0], s[1], s[6]
        self.reqId, content_length = (s[2]<<8)+s[3], (s[4]<<8)+s[5]
        self.content = ""
...
class FCGI (object):
    ...
    def __init__ (self):
        ...
        while remaining:
            ...
            elif r.reqId != self.requestId and \
                 r.recType != FCGI_BEGIN_REQUEST:
                continue
